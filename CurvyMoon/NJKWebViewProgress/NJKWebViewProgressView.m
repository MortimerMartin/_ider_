...
-(void)configureViews
{
    ...
    _progressBarView = [[GradienProgressView alloc] initWithFrame:self.bounds];
...
//    _progressBarView.backgroundColor = BackBlue;
...
- (void)setProgress:(float)progress animated:(BOOL)animated
{
    ...
    [UIView animateWithDuration:(isGrowing && animated) ? _barAnimationDuration : 0.0 delay:0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
        ...
        _progressBarView.gradienlayer.frame = frame;
//            _progressBarView.toValue = _progress;
//        [_progressBarView startAnimaition];
    } completion:nil];
